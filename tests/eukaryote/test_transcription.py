...
class TranscriptionSubmodelGeneratorTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        compartments = {'n': ('nucleus', 5E-14), 'm': ('mitochrondria', 2.5E-14)}
    ...
    def test_methods(self):            
        ...
        self.assertEqual(sorted([i.name for i in self.model.reactions]), sorted(['transcription transcript1', 'transcription transcript2']))
        ...
        self.assertEqual(self.model.observables.get_one(name='RNA Polymerase II observable in mitochrondria').expression.expression,
            'complex3[m]')
